...
function App() {
  ...
  const [videoLoaded, setVideoLoaded] = useState(false); // Для лоадера
  ...
  useEffect(() => {
    ...
    // Снег с отрицательной задержкой
  ...
  return (
    <div className="mobile-frame">
       ...
       {/* LOFI OVERLAY */}
       {isLofi && (
         <div className="lofi-wrapper fade-in">
            {/* КНОПКА ВЫХОДА */}
